package com.zwyl.myhomework.http;
...
import com.zwyl.myhomework.BuildConfig;
import com.zwyl.myhomework.util.MD5Util;
...
public class ApiUtil {
     ...
     * @return
     */
    public static <T> T createUploadApi(final Class<T> service, String token) {
        return createDefaultApi(service, 120, token);
    }
